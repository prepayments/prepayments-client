...
import { ICompilationRequest, CompilationRequest } from 'app/shared/model/compilation/compilation-request.model';
...
describe('Service Tests', () => {
  describe('CompilationRequest Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new CompilationRequest(0, 'AAAAAAA', 0, CompilationStatus.IN_PROGRESS, CompilationType.AMORTIZATION_ENTRY_COMPILATION);
    });
